...
Author: Morris Mani, Cohen David.
Plugin URI: "https://www.jewtech.co.il".


==Description==

This plugin is intended to help website owners (commercial and general)  and visitors to observe the Shabbat and Jewish holidays by preventing commercial activity and actions involving 'Chilul  Shabbat'.
Closing the site: The plugin will pop up a designed message to the visitors, the pop-up contains a timer that shows the time left until the end of Shabbat or the holiday. The plugin is located on top of the of the websites content and does not change the content and does not redirect the visitors to another page.
...
תוסף זה מיועד לבעלי אתרים (מסחריים ובכלל) המעוניינים לסגור את הפעילות האתר בימי שבת וחג, בכדי לשמור על קדושת השבת והחג במניעת פעילות מסחרית ופעולות הכרוכות בחילול שבת וחג.
סגירת האתר: התוסף יקפיץ הודעה מעוצבת למשתמש בימי שבת וחג אודות סגירת האתר, החלון הקופץ מכיל טיימר המציג את הזמן שנותר עד לצאת השבת או החג. התוסף ממוקם על גבי תוכן האתר ואינו משנה את התכנים באתר או מפנה את הלקוח לדף אחר.
